    ...
    def set_bandwidth_queue(self):
        ...
        for port in ports:
            queuecmd = "sudo ovs-vsctl -- set port %s qos=@defaultqos " \
                       "-- --id=@defaultqos create qos type=linux-htb other-config:max-rate=10000000 queues=0=@q0,1=@q1,2=@q2 " \
                       "-- --id=@q0 create queue other-config:min-rate=8000000 other-config:max-rate=8000000 " \
                       "-- --id=@q1 create queue other-config:min-rate=3000000 other-config:max-rate=8000000 " \
